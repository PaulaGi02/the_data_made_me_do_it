    ...
    <div ref={containerRef} className={`relative z-10 ${isSingle ? 'h-[400vh]' : 'h-[900vh]'}`}>
      ...
      <div className="sticky top-0 h-screen w-full flex items-center justify-center p-4 md:p-8 lg:p-12 z-0 overflow-hidden pointer-events-none">
        ...
        >
          ...
          <div className="absolute top-10 left-10 w-20 h-20 border-t-2 border-l-2 border-dg/5 rounded-tl-[1rem] pointer-events-none" />
          <div className="absolute bottom-10 right-10 w-20 h-20 border-b-2 border-r-2 border-dg/5 rounded-br-[1rem] pointer-events-none" />
        </motion.div>
      </div>
