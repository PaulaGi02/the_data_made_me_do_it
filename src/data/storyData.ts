...
export const storyData: StorySection[] = [
  ...
  },
  {
    ...
    paragraphs: {
      explanation: "Beef sits at the top of this chart, emitting nearly 100kg of CO₂ per kilogram of meat produced.",
  ...
  },
  {
    ...
    paragraphs: {
      explanation: "When averaged out, meat produces about 29kg of CO₂ per kg. Dairy and vegetarian products sit around 10kg.",
